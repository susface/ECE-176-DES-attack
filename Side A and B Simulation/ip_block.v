// ip_block.v — DES Initial Permutation (FIPS 46-3)
module ip_block (
    input  [63:0] data_in,
    output [63:0] data_out
);
    // data_in[63] = bit 1, data_in[0] = bit 64

    assign data_out[63] = data_in[64-58]; // bit 58
    assign data_out[62] = data_in[64-50];
    assign data_out[61] = data_in[64-42];
    assign data_out[60] = data_in[64-34];
    assign data_out[59] = data_in[64-26];
    assign data_out[58] = data_in[64-18];
    assign data_out[57] = data_in[64-10];
    assign data_out[56] = data_in[64- 2];

    assign data_out[55] = data_in[64-60];
    assign data_out[54] = data_in[64-52];
    assign data_out[53] = data_in[64-44];
    assign data_out[52] = data_in[64-36];
    assign data_out[51] = data_in[64-28];
    assign data_out[50] = data_in[64-20];
    assign data_out[49] = data_in[64-12];
    assign data_out[48] = data_in[64- 4];

    assign data_out[47] = data_in[64-62];
    assign data_out[46] = data_in[64-54];
    assign data_out[45] = data_in[64-46];
    assign data_out[44] = data_in[64-38];
    assign data_out[43] = data_in[64-30];
    assign data_out[42] = data_in[64-22];
    assign data_out[41] = data_in[64-14];
    assign data_out[40] = data_in[64- 6];

    assign data_out[39] = data_in[64-64];
